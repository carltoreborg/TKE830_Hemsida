    ...
    <div>
      <div className="relative z-10 container mx-auto flex items-center justify-center">
            ...
            <div className="background-block">
              <h2 className="text-3xl font-bold sm:text-4xl lg:text-3xl xl:text-4xl mb-4">Usability & Desirability</h2>
          ...
          <div className="w-full px-4 lg:w-1/2 flex justify-center lg:justify-end">  
                <div className="background-block">
                <h2 className="text-3xl font-bold sm:text-4xl lg:text-3xl xl:text-4xl mb-4">Feasibility & Viability</h2>
              ...
              <div className="w-full px-4 lg:w-1/2 flex justify-center lg:justify-end">  
                <div className="background-block">
                <h2 className="text-3xl font-bold sm:text-4xl lg:text-3xl xl:text-4xl mb-4">Sustainability</h2>
